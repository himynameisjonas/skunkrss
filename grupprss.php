...
// extract the main part of the html page
	...
	$end = 'function setAll(nn) {';
	$forsta = get_string($alltext, $start, $end);
	$bigtext=$forsta;

// count the diary posts

	$count_start = "<nobr><font size=\"2\" color=\"#ffffff\" face=\"verdana, arial, sans-serif\">";
	$count = get_count($count_start,$bigtext);
	$counter = 1;

// get the nickname of the person
	$start = "<table width=\"140\" border=\"0\" cellpadding=\"3\" cellspacing=\"0\">";
	$end = "</b> </font> </td>";
...
*/
	...
	$content = explode("title=\"Skicka mess\" style=\"color:#ffffff\">&raquo;</a>",$bigtext);
